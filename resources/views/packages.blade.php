                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-8 col-lg-9 col-md-12 ">
                            <div class="hero__caption hero__caption2 text-center">
                                ...
                                <p data-animation="fadeInLeft" data-delay=".8s"> Begin your crypto mining journey with our affordable Starter Mining Package, providing you with the necessary tools and resources to start mining popular cryptocurrencies.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
          ...
          <div class="uk-width-1-4">
                <div class="pricing-package">
                    <form action="" data-toggle="validator" role="form" id="stForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
          ...
          <div class="uk-width-1-4">
                <div class="pricing-package">
                    <form action="{{url('PackagesBuy')}}" data-toggle="validator" role="form" id="stForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
          ...
          <div class="uk-width-1-4">
                <div class="pricing-package">
                    ...
                    @CSRF<input type="text" value="Gold_Package1" name="Package_name" hidden="">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
          ...
          <div class="uk-width-1-4">
                <div class="pricing-package">
                    <form action="{{url('PackagesBuy')}}" data-toggle="validator" role="form" id="stForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    <input type="text" value="Diamond_Package1" name="Package_name" hidden="">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
          ...
          <div class="uk-width-1-4">
                <div class="pricing-package">
                    <form action="{{url('PackagesBuy')}}" data-toggle="validator" role="form" id="stForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                   @csrf
                    <input type="text" value="Diamond_Package2" name="Package_name" hidden="">
