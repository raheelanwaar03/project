<nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('Total_User')}}">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('Payment_User')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('Withdrawal_User')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('#')}}">
              ...
              <span class="menu-title">Pakcages Info</span>
            </a>
          </li>
        </ul>
      </nav>